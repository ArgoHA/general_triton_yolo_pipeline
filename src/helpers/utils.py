...
from src.helpers.ptypes import color_mapping, label_to_name_mapping
...
def draw_results(results, frame):
    ...
    for result in results:
        for idx, box in enumerate(result["boxes"].tolist()):
            class_id = int(result["class_ids"][idx])
            class_name = label_to_name_mapping[class_id + 1]
            annotator.box_label(box, class_name, color_mapping[class_id + 1])
    res_frame = annotator.result()
    return res_frame
